...
const WALLET =
  "0xd1a2bb83f4f3e2df6de6056952b71cd317968a80cde488ef6920a129e1b65306";
const EMOJIS = [
  "😀",
  "🙂",
  "😐",
...
// HARDCODED
const DATABASE_OBJECT_ID =
  "0x3c8d988415c83935f3f015da30716c331b4226acc3643d94bbfc9d66bbcab310";
...
const MOCK = [
  "Today I felt a little bit ill, but I'm hopeful for tomorrow.",
  "I have enjoyed the calming exercises recommended by my therapist, although sometimes are challenging.",
];
          ...
          .map((res, i) => {
            ...
            if (!content || content.dataType !== "moveObject") {
              ...
              return {
                ...
                visibility: "public",
                updatedKey: Number(obj.data?.version ?? 0),
                status: "invalid",
                reason: "no_content",
              };
            }
            ...
            try {
              ...
              const ts =
                parsed.timestamp != null ? Number(parsed.timestamp) : undefined;
              ...
              return {
                ...
                message:
                  i in [0, 1] && account?.address === WALLET
                    ? MOCK[i]
              ...
              console.warn(
                "invalid JSON in fields.content",
                id,
                fields.content,
                e,
              );
      ...
      <div className="relative z-10 space-y-6">
        <header>
          ...
          <p className="mt-1 text-sm">
            Browse private posts shared anonymously by others.
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                ...
                <CardContent>
                  ...
                  <p className="mt-2 text-xs opacity-70">
                    ID: {post.id.slice(0, 10)}… • key {post.updatedKey}
                  </p>
                </CardContent>
              </div>
            </Card>
          ...
          {filtered.length === 0 && (
            <div className={glassClasses + " p-6 text-sm text-black"}>
